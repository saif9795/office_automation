...
const SHEET_ID = "11FEUXKQerOWXbq_CDt9XD7uhvl66nAsOJSlmNPoOH6k"; // Replace with your actual Google Sheet ID
...
app.post('/webhook', async (req, res) => {
    console.log('🔔 Webhook triggered! Data received:', req.body);

    const data = await getSheetData();
    io.emit('update', data); // Send real-time update to frontend
